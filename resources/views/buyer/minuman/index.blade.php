...
@else
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 mt-3 mb-5">
        @foreach($barang as $item)
            <div class="col">
                <a href="{{ route('detail.index', $item->id_barang) }}">
                    <div class="card card2 h-100">
                        <div style="position: relative;">
                            ...
                            @else
                                <img src="{{ asset('icon\Minuman.png') }}" class="card-img-top" alt="{{ $item->nama_barang }}" style="height: 200px; object-fit: contain; background-color: #eee;">
                            @endif
