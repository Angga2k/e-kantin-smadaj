...
<head>
    ...
    <title>Kantin SMA Negeri 2 Jember</title>
    ...
    <style>
        ...
        .hero-banner {
            background-color: #ff9800; /* Warna oranye seperti di gambar */
            /* Di sini Anda bisa menambahkan gambar background pattern */
        ...
        .card .price {
            font-weight: 700;
            color: #0d6efd; /* Warna biru untuk harga */
            font-size: 1.1em;
        }
    ...
    <main class="container my-4">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <div style="position: relative;">
                        <img src="" class="card-img-top" alt="Ayam Goreng" style="height: 200px; object-fit: cover; background-color: #eee;">
            ...
            <div class="col">
                <div class="card h-100">
                     <div style="position: relative;">
                        <img src="" class="card-img-top" alt="Nasi Padang" style="height: 200px; object-fit: cover; background-color: #eee;">
                        <div class="rating-badge"><i class="bi bi-star-fill"></i>5.0</div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                     <div style="position: relative;">
                        <img src="" class="card-img-top" alt="Es Buah" style="height: 200px; object-fit: cover; background-color: #eee;">
                        <div class="rating-badge"><i class="bi bi-star-fill"></i>5.0</div>
                    </div>
                    <div class="card-body">
