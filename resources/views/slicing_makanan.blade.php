...
<head>
    ...
    <title>Makanan - Kantin SMA Negeri 2 Jember</title>
    ...
    <style>
        /* CSS ini sama dengan kode sebelumnya, dengan sedikit tambahan */
        body {
            font-family: 'Poppins', sans-serif;
            background-color: #f8f9fa;
        }
        /* BARU: Style untuk top bar dashboard */
        .dashboard-bar {
            background-color: #424242; /* Warna abu-abu gelap */
            color: white;
            padding: 0.5rem 1rem;
            font-weight: 500;
            font-size: 0.9em;
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/makanan">Makanan</a>
                        </li>
                        <li class="nav-item">
